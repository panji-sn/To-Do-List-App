...
greeting.innerHTML = "Apa rencana anda "+localStorage.getItem("user")+" ?";
(function() {
  ...
  function addTaskToList(task) {
    ...
    updateIcon.innerHTML = "Perbaharui";
  ...
  function updateTask(event) {
    ...
    if (!!taskToUpdate) {
      var des = prompt("Ubah Pengingat", taskToUpdate.taskDes);
      var state = prompt("Ubah tanggal", taskToUpdate.taskState);
